...
<script type="text/javascript">
 function addMarks(id){
	...
	$("#studentId").val(id);
	$('#addMarksForm').modal({backdrop: 'static', keyboard: false})
	$("#addMarksForm").modal('show');
                    ...
                    <button type="submit" class="btn btn-inverse btn-sm pull-right" data-toggle="modal" data-target="#forClientRegistration" data-backdrop="static" data-keyboard="false"><i class="fa fa-plus-circle"></i>  Add Exam</button>                    
